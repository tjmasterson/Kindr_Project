      ...
      <div className="panel panel-default">
        <div className="col-sm-4 col-xs-6">
          <div className="dispensary_item">
            ...
            <p></p>
            <div className="btn btn-success text-center"><a href={"dispensaries/" + dispensary_strain.dispensary_id + "/dispensary_strains/" + dispensary_strain.disp_strain_id + "/new_user_choice_collection"}>Rate {dispensary_strain.name}</a>
            </div>
