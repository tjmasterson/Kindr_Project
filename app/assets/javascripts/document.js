$(document).ready(function(){
  ...
  var dispensaryMarkupGenerator = _.template("<div class='col-sm-4 col-xs-6'> <div class='dispensary_item'> <p> <h4 class='dispensary_item_name'> <a href='dispensary/<%= id %>'><%= name %></a> </h4></p><p></p> <div class='panel-thumbnail'> <a href='#' title='Renovations'> <img src='//placehold.it/600x400/444/F8F8F8' class='img-responsive'/> </a> </div> </div> </div>");
